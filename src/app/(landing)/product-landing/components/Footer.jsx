...
const Footer = () => {
  return <footer className="relative md:pt-20 pt-12 md:pb-0 border-t border-default-200">
    ...
    <div className="lg:py-10 py-6 mt-12 text-center text-default-500 text-base border-t border-default-200">
      <p>
        {currentYear} © BisikBerbisik. Design & Develop by{' '}
        <Link to="#" rel="noopener noreferrer" className="underline text-default-800 font-bold transition-all hover:text-primary">
          ABHIVARDHANA ANVAYA
        </Link>
      </p>
    </div>
